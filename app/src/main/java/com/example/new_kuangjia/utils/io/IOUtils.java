package com.example.new_kuangjia.utils.io;

import android.os.Build;
import com.example.new_kuangjia.utils.io.stream.*;
...
public class IOUtils {
     ...
     * </ul>
     * It can be used in favor of {@link #toByteArray(java.io.InputStream)}, since it
    ...
    public static InputStream toBufferedInputStream(InputStream input) throws IOException {
        return com.example.new_kuangjia.utils.io.stream.ByteArrayOutputStream.toBufferedInputStream(input);
    }
    ...
    public static byte[] toByteArray(InputStream input) throws IOException {
        com.example.new_kuangjia.utils.io.stream.ByteArrayOutputStream output = new com.example.new_kuangjia.utils.io.stream.ByteArrayOutputStream();
        copy(input, output);
     ...
     * before using {@link com.litesuits.common.io.IOUtils.toByteArray (java.io.InputStream, int)} to read into the byte array.
     ...
     * @throws IllegalArgumentException if size is less than zero or size is greater than Integer.MAX_VALUE
     //* @see com.litesuits.common.io.IOUtils#toByteArray(java.io.InputStream, int)
     * @since 2.1
     */
